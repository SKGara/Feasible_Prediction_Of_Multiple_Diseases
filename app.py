...
st.set_page_config(page_title="Feasible Prediction of Multiple Diseases",layout="wide", page_icon="👨‍🦰🤶")
...
kidney_disease_model = pickle.load(open(f'{working_dir}/kindey.pkl','rb'))
...
with st.sidebar:
    selected = option_menu("Feasible Prediction of Multiple Diseases", 
